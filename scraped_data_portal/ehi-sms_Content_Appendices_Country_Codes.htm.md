...
Country codes are based on the Visa and Mastercard country codes, which are generally based on [ISO 3166 country codes](http://www.iso.org/iso/home/standards/country_codes.htm), but with some exceptions (as described below). You should use the correct alpha-3, alpha-2 or numeric-3 code correctly as described below.

| Country Name | Country 3-alpha code | Country 2-alpha code | Country 3-numeric code |
| --- | --- | --- | --- |
| Afghanistan | AFG | AF | 004 |
| Ãland Islands | ALA | AX | 248 |
| Albania | ALB | AL | 008 |
| Algeria | DZA | DZ | 012 |
...
| Kosovo â see âUNMI Kosovoâ below | See below | See below | See below |
| Kuwait | KWT | KW | 414 |
...
| Qatar | QAT | QA | 634 |
| RÃ©union | REU | RE | 638 |
| Romania | ROM[1 Note that this differrs from the ISO 3-digit country code for Romania of ROU.](#) | RO | 642 |
| Russian Federation | RUS | RU | 643 |
| Rwanda | RWA | RW | 646 |
| Saint BarthÃ©lemy | BLM | BL | 652 |
