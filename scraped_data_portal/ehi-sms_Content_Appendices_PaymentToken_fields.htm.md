...
| 7 | Cardholder will receive voice call | Mobile phone number held on Thredd for the cardholder |

## 4.22.2 PaymentToken\_deviceType
...
## 4.22.4 PaymentToken\_creatorStatus
...
This field can contain â â or be empty when no value has been provided.
...
## 4.22.6 PaymentToken\_PanSource
...
| P | Card added via application / Mobile banking app |
| W | DPAN input from Wallet Provider (Token to Token) |