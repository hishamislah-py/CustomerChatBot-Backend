...
Currency codes are based on the [ISO 4217](http://www.iso.org/iso/currency_codes) specification.

Thredd uses the currency exponent in all fields containing an amount. See [Amounts and Currency Exponents](#Amounts).
...
| STD | 678 | 2 | SÃ£o TomÃ© and PrÃ­ncipe dobra (old) |
| STN | 930 | 2 | SÃ£o TomÃ© and PrÃ­ncipe dobra (new) |
| SVC | 222 | 2 | Salvadoran colÃ³n |
...
| VES | 928 | 2 | Venezuelan bolÃ­var soberano (new) |
