...
### Payment Authorisation for Single Message Systems

If you are offering cards in regions that support [Single Message Systems](Single_vs_Dual_Message.htm), and have been set up for receiving relevant messages, instead of an authorisation message you will receive an online financial request. This is the equivalent to an authorisation, the main difference is that instead of placing a block on the amount, you change the balance immediately.

![](../Resources/Images/SMS-transaction-flow-overview.png)

Figure 2: Parties involved in the SMS payment authorisation process

If you want to receive online financial messages, then this option must be configured at both Thredd and Card Scheme level. For more information, contact your implementation manager.

You can still receive 0100 pre-authorisation messages in single message systems, but those are later finalised by online financial advices.