...
## 4.40.1 Visa\_POS\_Data\_DE60 Positions
...
## 4.40.2 Position 1 â Terminal Type
...
## 4.40.3 Position 2 â Terminal Entry Capability
...
## 4.40.4 Position 3 â Chip Condition Code
...
## 4.40.5 Position 4 â Special Condition (existing debt)
...
## 4.40.6 Position 7 â Chip Transaction Indicator
...
## 4.40.7 Position 8 â Chip Card Authentication Reliability Indicator
...
## 4.40.8 Position 9-10 â Mail/Phone/E-Commerce/Payment Indicator
...
## 4.40.9 Position 11 â Cardholder ID Method Indicator
...
## 4.40.10 Position 12 â Additional Authorisation Indicators
