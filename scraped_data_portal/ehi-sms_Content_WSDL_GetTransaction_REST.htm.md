# 4.42 GetTransaction Example Messages
...
## 4.42.2 Example Authorisation Reversal
...
## 4.42.3 Example Financial Presentment (Mastercard)
...
## 4.42.4 Example Second Financial Presentment (Mastercard)
...
## 4.42.5 Financial Reversal (Mastercard)
...
## 4.42.6 Financial Reversal (Visa)
...
## 4.42.7 Example Visa Authorisation Advice
...
## 4.42.8 Example Mastercard Authorisation Advice
...
## 4.42.9 Example Non-Credit Chargeback Notification (Mastercard)
...
## 4.42.10 Example Chargeback Notification (Mastercard)
...
## 4.42.11 Example Chargeback Reversal (Mastercard)
...
## 4.42.12 Example Balance Enquiry Message
...
## 4.42.13 Example ATM Cash Withdrawal Messages (Mastercard)
...
## 4.42.14 Example Tokenisation Messages
...
## 4.42.15 Example Incremental Authorisation Messages
...
## 4.42.16 Examples of Amount Signs
