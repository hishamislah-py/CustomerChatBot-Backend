...
Figure 29: Parties involved in transaction authorisation
...
| 01 | Manual [cash disbursementsClosed Type of transaction where cash is given to the cardholder, for example, from a bank branch by a member of staff using a Point of Sale (POS) terminal.](#) - Authorisation transactions  Example of a manual cash disbursement: A POS device in a bank branch operated by bank staff is used, and if approved, the bank employee hands cash over the counter to the cardholder. | Maestro cards only | 6010 |
...
During conversion in EHI to the XML format, data is UTF-8 encoded according to the XML specification. See: [Extensible Markup Language (XML) 1.0 (Fifth Edition)](https://www.w3.org/TR/xml/#syntax).
...
| Hexadecimal character | Description | Converted to in XML | Example: Original 0100 Message | Example: Conversion to XML Format |
| --- | --- | --- | --- | --- |
| U+0000 | The null character, 0 | &#x0; | <Merch\_City>Tr Cora es</Merch\_City> | <Merch\_City>Tr&#x0;s Cora&#x0;&#x0;es</Merch\_City> |
| U+0000 | ? | &#x0; | <Merch\_Name>Hotels,Mo ???????????????????????????LCA</Merch\_Name> | <Merch\_Name>Hotels,Mo&#x0;LCA</Merch\_Name> |
| 0152 | Å | &#x1A; | <Merch\_City>Mons-en-BarÅul</Merch\_City> | <Merch\_City>Mons-en-Bar&#x1A;ul</Merch\_City> |
