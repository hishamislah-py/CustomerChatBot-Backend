...
* When integrating to EHI, always refer to the GetTransaction WSDL for the latest EHI XML structure. See [GetTransaction WSDL and Example Messages](../WSDL/GetTransaction_WSDL.htm).