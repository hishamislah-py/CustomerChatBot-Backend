...
Figure 7: Thredd System Components and External Host Interface Message Flow
...
* **Real-time authorisation**
  **/financial**
   **requests** - which require an immediate approve or decline decision and response. If not responded to in time, Thredd or the Card Scheme may provide Stand-In Processing (STIP)
