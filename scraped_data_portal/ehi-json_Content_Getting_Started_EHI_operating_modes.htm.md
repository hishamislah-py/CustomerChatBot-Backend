...
Figure 2: Gateway Processing (Mode 1) - external host approves transaction
...
Figure 3: Cooperative Processing (Mode 2) - Thredd approves in first instance
...
Figure 4: Full Service Processing (Mode 3) - Thredd approves and external host receives data subscription service only
...
Figure 5: Gateway Processing with STIP (Mode 4) - External host approves, but Thredd can stand in if external host is not available
