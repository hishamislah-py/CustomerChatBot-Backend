# 1.6 Transaction Flow Scenarios
...
Figure 8: Authorisation Flow - Approve
...
Figure 9: Authorisation Flow - Decline
...
Figure 10: Authorisation Reversal Flow
...
Figure 12: Incremental Authorisation Reversal Flow
...
Figure 13: AFD Authorisation and Settlement Flow
...
2. Thredd generates a partial authorisation reversal for 10 GBP (`Txn_Type` = D, Credit) linked to the original preauthorisation (reducing the full authorised amount from 100 GBP to 90 GBP).
...
2. Thredd generates a partial authorisation reversal for 10 USD (`Txn_Type` = D, Credit) linked to the original preauthorisation (reducing the full authorised amount from 100 USD to 90 USD).
