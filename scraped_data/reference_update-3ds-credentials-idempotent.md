  ...
  "paths": {
    "/api/v1/cards/{publicToken}/3ds-credentials/{credentialId}": {
      "patch": {
        ...
        "summary": "Update 3DS Credentials - Idempotent",
        "operationId": "update-3ds-credentials---idempotent",
        "parameters": [
          {
            "name": "credentialId",
            "in": "path",
        ...
        "requestBody": {
          "description": "GPS.API.Core.Models.Request.V1.CardCredentials.Update3DSCredential",
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/Update3DSCredential"
              }
            },
            "text/json": {
              "schema": {
      ...
      "Update3DSCredential": {
        ...
        "properties": {
          "value": {
            "minLength": 1,
            "type": "string",
            "description": "The value of the credential to be updated. For example, email address or telephone number.",
            "example": "07796456220"
          },
          "cardholderAnswer": {
            "maxLength": 45,
        ...
        "description": "3DS Credential update request."
      }
    },
    "securitySchemes": {
      "OAuth2": {
