...
> 👍 Documentation
>
> For more information on getting merchants from the disallow list, see [Merchant Disallow Lists](https://cardsapidocs.thredd.com/docs/merchant-disallow-lists).
...
```json
{
  ...
  "paths": {
    "/api/v1/groups/disallow-merchant": {
      "get": {
        "tags": [
          "Merchants"
        ],
        "summary": "Get Disallowed Merchants",
        "operationId": "get-disallowed-merchants",
        "responses": {
          "200": {
            "description": "Success",
            "content": {
