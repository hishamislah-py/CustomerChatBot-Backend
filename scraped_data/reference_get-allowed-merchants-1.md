...
> 👍 Documentation
>
> For more information on getting merchants from the allow list, see [Merchant Allow Lists](https://cardsapidocs.thredd.com/docs/merchant-allow-lists).
...
```json
{
  ...
  "paths": {
    "/api/v1/groups/allow-merchant": {
      "get": {
        "tags": [
          "Merchants"
        ],
        "summary": "Get Allowed Merchants",
        "operationId": "get-allowed-merchants",
        "responses": {
          "200": {
            "description": "Success",
            "content": {
