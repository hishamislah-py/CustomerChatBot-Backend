...
> 👍 Documentation
>
> For more information on adding merchants to the disallow list, see [Merchant Disallow Lists](https://cardsapidocs.thredd.com/docs/merchant-disallow-lists).
...
```json
{
  ...
  "paths": {
    "/api/v1/groups/disallow-merchant/{listId}": {
      "post": {
        "tags": [
          "Merchants"
        ],
        "summary": "Add Merchant to Disallow List",
        "operationId": "add-merchant-to-disallow-list",
        "parameters": [
          {
            "name": "listId",
            "in": "path",
            "description": "The ID for the disallow list you want to add a merchant to.",
            "required": true,
            "schema": {
              "type": "integer",
              "format": "int32"
